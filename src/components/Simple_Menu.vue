<template>
  <div class="py-2">
       <ul class="space-y-8">
        ...
        <div  class="flex flex-row p-3  bg-gradient-to-r from-amber-600 via-amber-600 to-amber-400   font-semibold shadow-lg" >
...
const active7 =  ref(false);

const active_menu7 = ()=>{
  active7.value =!active7.value;
}
